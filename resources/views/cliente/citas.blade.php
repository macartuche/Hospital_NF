    ...
    <div class="container">
        ...
        <div class="container">
            <form action="/action_page.php">
                ...
                <hr>
                <p>Recuerde que los horarios de atención son en la mañana desde las 9:00 hasta las 12:00, y por la tarde
                    desde las 16:00 hasta las 18:00.
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <textarea name="textarea" rows="10"
                            cols="50">Escriba algún detalle adicional a considerar</textarea>
                    </div>
                </div>
            </form>
        </div>
