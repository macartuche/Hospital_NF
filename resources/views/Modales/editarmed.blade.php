        ...
        <div class="modal fade" id="editarMedicoModal{{$medico->id}}" tabindex="-1" role="dialog" aria-labelledby="editarmedicoModal" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <!-- Modal Body -->
                    <form action="{{route('editarmed', $medico->id)}}" method="POST">
                        <div id="modalBody" class="modal-body">
                            ...
                            <!-- Formulario -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" name="email" value = {{$medico->email}} class="form-control" required maxlength="100">
                                </div>
                                <div class="form-group">
                                    <label for="especialidadDescripcion">Teléfono</label>
                                    <input type="text" id="telefono" name="telefono" value = {{$medico->telefono}} class="form-control" required maxlength="100">
                                </div>
                                <div class="form-group">
                                    <label for="especialidadDescripcion">Dirección</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password" name="password" value = "" class="form-control" required maxlength="100">
                                </div>
                        </div>
                        <!-- Modal Footer -->
